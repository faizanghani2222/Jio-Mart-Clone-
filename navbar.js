let mynav=()=>{
    ...
    <label>
        ...
        <div class="slide">
            ...
            <ul>
              ...
              <li><a href="business.html">Beauty</a></li>
    ...
    <div id="navbar">
      ...
      <h2><a href="cart.html"><i class="fa-solid fa-cart-shopping"></i>Cart</a></h2>
      </div>
    </div>
    <div id="seminav">
        <ul>
            <li><a href="">Groceries<i class="fa-solid fa-chevron-down"></i></a>
                <ul>
            ...
            <li><a href="">Beauty<i class="fa-solid fa-chevron-down"></i></a>
                <ul>
